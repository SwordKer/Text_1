...
$(function () {
	...
	$('#sends').click(function() {
		...
		$.post('http://localhost/wish/index.php/Index/Index/handel',{username:user.val(),content:cont.val()},
			function(result){
				console.log(result);
					var str = "<dl class='paper a1'><dt><span class='username'>"+result.username+"</span>";
						str += "<span class='num'>2</span></dt>";
						str += 	"<dd class='content'>"+result.content+"</dd>";
						str += 	"<dd class='bottom'>";
						str += 	"<span class='time'>4</span>";
