...
<!--主体-->
	<div class='main'>
		<div class='main-left'>
			<p>后盾博文</p>
			<?php if(is_array($blog)): foreach($blog as $key=>$v): ?><dl style="margin:1px">	
					<dt><?php echo ($v["name"]); ?>aa<a href="">更多>></a></dt>
					<?php if(is_array($v["text"])): foreach($v["text"] as $key=>$k): ?><dd>
							<a href=""><?php echo ($k["title"]); ?></a>
							<span><?php echo (date("y-m-d",$k["time"])); ?></span>
